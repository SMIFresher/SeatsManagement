...
public class GenericDaoImpl<T> implements GenericDao<T>{
	...
	private static final Logger logger = LoggerFactory.getLogger(GenericDaoImpl.class);
	 ...
	 public T saveOrUpdate(T t){
			...
			hibernateTemplate.saveOrUpdate(t);
				...
				throw new ApplicationException("Error while inserting records in "+t.getClass().getSimpleName(), e);
			}
	...
	public T getById(T t,UUID id) {
		...
		try{
			...
			throw new ApplicationException("Error while retriving records"+t.getClass().getSimpleName(), e);
		}
	...
	public boolean delete(T t) {
		...
		logger.info("Dao: "+t.getClass().getSimpleName()+"(GenericDaoImpl)  Method : delete started at : " + LocalDateTime.now());
			...
			try{
				...
				throw new ApplicationException("Error while deleting records"+t.getClass().getSimpleName(), e);
			}
	...
	public void saveAll(List<T> objectsList) {
		for(T obj : objectsList) {
			...
			try{
				...
				throw new ApplicationException("Error while inserting bulk records"+obj.getClass().getSimpleName(), e);
			}
