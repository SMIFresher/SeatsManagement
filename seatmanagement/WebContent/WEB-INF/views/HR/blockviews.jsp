...
<body>
 ...
 <div id="build" ng-app="workplaceManagement" ng-controller="workplaceManagementController" ng-init="blockDetailsByFloor('${id}'); blockDetails();">
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-9">
    		...
    		<div class=" col-sm-3 " ><a href="ModifyBlock"><div class="option"><span class="fa fa-cogs"></span></div></a></div>
			    ...
			    <div class="col-md-4 ">
			   		<a href="/seatmanagement/Blocks/BlockView">
				    	<div class="content text-center" >
				    		<br>
				    	   <h3>+</h3>
					      <h3>Add</h3>
